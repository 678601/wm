...
/**
 * @author LiWenMing
 * @Description TODO 引用网上算法 https://github.com/iTimeTraveler/SortAlgorithms/blob/master/src/main/java/com/example/SortAlgorithms.java
 * algorithm - 必应词典
 * 美['ælɡə.rɪðəm]英['ælɡə.rɪð(ə)m]
 * n.【数】算法；规则系统；演段
 * 网络演算法；运算法则；算法之美
 * 变形复数：algorithms；
 * @createTime 2020/12/30/0030 20:02
 */
...
////        array = SortAlgorithms.mergingSort(array);
     ...
     * 2. 再将关键字最大的记录K1 (即堆顶, 第一个元素)和无序区的最后一个记录 Kn 交换, 由此得到新的无序区K[1..n−1]和有序区K[n],
