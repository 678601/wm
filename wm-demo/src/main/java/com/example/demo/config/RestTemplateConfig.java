...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate(){
		...
		try {
			...
			logger.error("RestTemplateConfig--->restTemplate异常:"+e.getMessage(), e);
		}
		logger.info("RestTemplateConfig--->restTemplate结束,{},{},{},{}",maxTotalConnect,maxConnectPerRoute,connectTimeout,readTimeout);
		return restTemplate;
    }
}
